...
export class CoronaComponent implements OnInit {
  ...
  saveData(data){
    storage = data;
    CoronaComponent.visualizeData(5);
  }
  ...
  selectData(event) {
    ...
    if (!this.disabled && this.checkScale){
      if (this.selectedData == '3'){
        CoronaComponent.visualizeData(6);
      } else if (this.selectedData == '4'){
        CoronaComponent.visualizeData(7);
      } else if (this.selectedData == '5'){
        CoronaComponent.visualizeData(8);
      } else {
        console.log("Error: selectData...");
      }
    } else {
      CoronaComponent.visualizeData(this.selectedData);
    }
  }
  ...
  scaleTo100000(event){
    ...
    if (this.selectedData == '3' || this.selectedData == '6'){
      if (event.checked){
        ...
        CoronaComponent.visualizeData(3);
      }
    } else if (this.selectedData == '4' || this.selectedData == '7'){
      if (event.checked){
        CoronaComponent.visualizeData(7);
      } else {
        CoronaComponent.visualizeData(4);
      }
